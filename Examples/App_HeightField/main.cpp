...
#include"HeightField/HeightFieldVelocitySolve.h"
...
void CreateScene()
{
	...
	std::shared_ptr<HeightFieldVelocitySolve<DataType3f>> root = scene.createNewScene<HeightFieldVelocitySolve<DataType3f>>();
